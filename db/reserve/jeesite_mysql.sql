...
DROP TABLE IF EXISTS `reserve_commodity_supplier`;
CREATE TABLE `reserve_commodity_supplier` (
  `id` varchar(19) NOT NULL,
  `name` varchar(19) DEFAULT NULL COMMENT '供应商名称',
  `create_by` varchar(64) DEFAULT NULL,
  `create_date` datetime DEFAULT NULL,
  `update_by` varchar(64) DEFAULT NULL,
  `update_date` datetime DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `reserve_menu`;
...
DROP TABLE IF EXISTS `reserve_role_menu`;
CREATE TABLE `reserve_role_menu` (
  `id` varchar(19) NOT NULL,
  `fk_role_id` varchar(64) NOT NULL COMMENT '角色编号',
  `fk_menu_id` varchar(64) NOT NULL COMMENT '菜单编号',
  `create_by` varchar(64) DEFAULT NULL,
  `create_date` datetime DEFAULT NULL,
  `update_by` varchar(64) DEFAULT NULL,
  `update_date` datetime DEFAULT NULL,
