...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/reserve/reserveUser/form?id=${reserveUser.id}">商家用户<shiro:hasPermission name="reserve:reserveUser:edit">${not empty reserveUser.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="reserve:reserveUser:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="reserveUser" action="${ctx}/reserve/reserveUser/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="reserve:reserveUser:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
