...
public class AverageImageScale {
	...
	public static void resizeFix(File srcFile, File destFile, int boxWidth,
		...
		BufferedImage srcImgBuff = ImageUtils.readImage(srcFile);
		int width = srcImgBuff.getWidth();
		int height = srcImgBuff.getHeight();
		BufferedImage imgBuff = null;
		imgBuff = scaleImage(srcImgBuff, width, height,
				boxWidth, boxHeight);
	...
	public static void resizeFix(File srcFile, File destFile, int boxWidth,
		...
		if (width <= boxWidth && height <= boxHeight) {
			...
			imgBuff = scaleExpandImage(srcImgBuff, width, height,
					boxWidth, boxHeight);
	...
	//扩大图片
	private static BufferedImage scaleExpandImage(BufferedImage srcImgBuff,
	...
	public static void main(String[] args) throws Exception {
		...
		AverageImageScale.resizeFix(new File(
				"D:\\Demo\\pic1.jpg"), new File(
				"D:\\Demo\\pic2.jpg"), 600,300);
