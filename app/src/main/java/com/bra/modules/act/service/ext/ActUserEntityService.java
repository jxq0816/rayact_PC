 ...
 */
package com.bra.modules.act.service.ext;

import com.bra.common.utils.SpringContextHolder;
import com.bra.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.bra.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.bra.modules.sys.entity.User(null, userId)))){
