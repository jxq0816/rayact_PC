			 ...
			 <div class="span10">
				 <h3 style="color:#555555;font-size:20px;text-align:left;margin:10px 0;">回帖</h3>
					 <c:forEach items="${ptm}" var="post">
						 <div class="row" style="margin-left: 20px"><img src="${post.createBy.photo}" height="50px" width="50px" class="img-circle" name="${post.createBy.id}">${post.createBy.name}: &nbsp;${post.content} &nbsp; <fmt:formatDate value="${post.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/></div>
