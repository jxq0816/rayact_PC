...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cms/attitude/">点赞列表</a></li>
		<li class="active"><a href="${ctx}/cms/attitude/form?id=${attitude.id}">点赞${not empty attitude.id?'修改':'添加'}查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="attitude" action="${ctx}/cms/attitude/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">对象模块e：</label>
			<div class="controls">
