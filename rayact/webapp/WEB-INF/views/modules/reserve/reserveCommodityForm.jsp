...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/reserve/commodity/">商品列表</a></li>
    <li class="active"><a href="${ctx}/commodity/reserve/form?id=${commodity.id}">商品<shiro:hasPermission
            name="reserve:commodity:edit">${not empty commodity.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
            name="reserve:commodity:edit">查看</shiro:lacksPermission></a></li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="commodity" action="${ctx}/reserve/commodity/save" method="post"
