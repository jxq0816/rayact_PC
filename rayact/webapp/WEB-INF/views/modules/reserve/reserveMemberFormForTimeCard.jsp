...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/reserve/temporaryCardMember/list">次卡会员列表</a></li>
    <li class="active"><a href="${ctx}/reserve/temporaryCardMember/form?id=${reserveMember.id}">次卡会员<shiro:hasPermission
...
<br/>
<form:form id="inputForm" modelAttribute="reserveMember" action="${ctx}/reserve/temporaryCardMember/save" method="post"
    ...
    <table id="contentTable" class="table table-bordered">
        ...
        <tr>
            ...
            <td>剩余次数:</td>
            <td>
                <form:input path="residue" htmlEscape="false" maxlength="11" class="input-xlarge "/>&nbsp;次
            </td>
        </tr>
