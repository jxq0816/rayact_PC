...
App.page('main', function () {
    ...
    var memberCharX,memberCharY,venueCharX,venueCharY,commCharX,commCharY;
    function renderLine() {
        $.ajax({
            cache: true,
            type: "POST",
            ...
            url: ctx + "/reserve/loadJson",
            data: {},
            async: false,
            success: function (d) {
                memberCharX = d.memberListJson;
                memberCharY = '[' + d.memberChartMapY + ']';

                venueCharX = d.venueListJson;
                venueCharY = '[' + d.fieldChartMapY + ']';

                commCharX = d.commodityJson;
                commCharY = '[' + d.sellChartMapY + ']';

                //$("#memberSale").text("会员充值:"+ d.rechargeOfDay);
                var data = {
                    labels: memberCharX,
                    datasets: [
                        {
