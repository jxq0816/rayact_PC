...
function queryByDayForMemberIncome() {
    ...
    location.href=ctx + "/reserve/reserveCardStatements/listByStoredCardType?transactionType=1&startDate="+startDate+"&endDate="+endDate;
}
...
function queryByDayForCommoditySell() {
    var startDate=formatDate(now);
    var endDate=formatDate(now);
    location.href=ctx + "/reserve/reserveCardStatements/listByCommodityType?startDate="+startDate+"&endDate="+endDate;
}
