...
<jsp:include page="/WEB-INF/views/include/sidebar.jsp">
    <jsp:param name="action" value="commodityRecycleBin"></jsp:param>
</jsp:include>
        ...
        <div class="col-md-12">
            <div class="block-flat">
                ...
                <form:form id="searchForm" modelAttribute="reserveCommodity"
                           action="${ctx}/reserve/commodity/recycleBin"
                           method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-xs"
                                               href="${ctx}/reserve/commodity/recycle?id=${commodity.id}"
                                               onclick="return confirmb('确认要还原该商品吗？', this.href)">还原</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
