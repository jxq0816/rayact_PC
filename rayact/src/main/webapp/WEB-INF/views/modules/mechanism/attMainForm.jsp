...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/mechanism/attMain/">文档管理列表</a></li>
		<li class="active"><a href="${ctx}/mechanism/attMain/form?id=${attMain.id}">文档管理<shiro:hasPermission name="mechanism:attMain:edit">${not empty attMain.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="mechanism:attMain:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="attMain" action="${ctx}/mechanism/attMain/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="mechanism:attMain:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
