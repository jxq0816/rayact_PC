...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/reserve/temporaryCardMember/list">次卡会员列表</a></li>
    <shiro:hasPermission name="reserve:reserveMember:edit">
        <li><a href="${ctx}/reserve/temporaryCardMember/form">次卡会员添加</a></li>
    </shiro:hasPermission>
</ul>
<form:form id="searchForm" modelAttribute="reserveMember" action="${ctx}/reserve/temporaryCardMember/list" method="post"
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="reserveMember">
        <tr>
            <td><a href="${ctx}/reserve/temporaryCardMember/form?id=${reserveMember.id}">
                    ${reserveMember.name}
            </a></td>
            <td>
            ...
            <shiro:hasPermission name="reserve:reserveMember:edit">
                <td>
                    <a href="${ctx}/reserve/temporaryCardMember/form?id=${reserveMember.id}">修改</a>
                    <a href="${ctx}/reserve/temporaryCardMember/delete?id=${reserveMember.id}"
                       onclick="return confirmx('确认要删除该会员吗？', this.href)">删除</a>
                </td>
            </shiro:hasPermission>
        </tr>
    </c:forEach>
